function [accTrain,accBefore,accAfter] = stackedAEExercise(trainData,trainLabels,testData,testLabels)
...
[pred] = softmaxPredict(softmaxModel, sae2Features);
...
[ stackedAEOptTheta, grad ] = minFunc(@(p) stackedAECost(p,inputSize, hiddenSizeL2, ...
